package com.example.trananhthi;
...
public class MessageKeysGen {
    public static void main(String[] args) throws IOException {
        ...
        // For Eclipse, STS: remove "outlet-core-service/" in this path
        InputStream inputStream = new FileInputStream(
                "src/main/resources/i18n/messages_en.properties");
        BufferedReader br = new BufferedReader(new InputStreamReader(inputStream));
        Class<?> targetClazz = MessageCodes.class;
        File output = new File("src/main/java/"
                + targetClazz.getName().replaceAll(Pattern.quote("."), "/") + ".java");
